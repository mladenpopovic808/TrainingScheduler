...
//Klasa koja sluzi za slanje upita na druge mikroservise
@Configuration
public class UserServiceClientConfiguration {
    ...
    public RestTemplate userServiceRestTemplate() {
        ...
        restTemplate.setUriTemplateHandler(new DefaultUriBuilderFactory("http://localhost:8080/api")); //userservice
